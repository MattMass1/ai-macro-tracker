...
struct LiveCoachPresentation: Equatable {
    ...
    init(state: LiveCoachState) {
        ...
        case .listening:
            status = "Listening"
            detail = "Log a meal or your sets, check today's macros, or ask to change today's workout."
...
struct LiveCoachView: View {
    ...
    init(controller: LiveCoachController? = nil, refreshData: @escaping @MainActor () async -> Void = {}) {
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        Text("Try: “Replace bench press with dumbbell bench press today.”\nFor sets, say the exercise, reps, weight, and pounds or kilograms.")
                            .font(.footnote)
