...
EXERCISE COUNT RULE: 3-8 exercises per day, but ASK the user their preferred session size during onboarding (offer: 3-4 light, 5-7 moderate, 8+ heavy) and build to what they pick. If they don't state a preference, default to 5-6. Include the chosen range as "session_size" in the plan (e.g. "3-4", "5-7", "7-8"). The user can add more from the library later if they want.""", {"plan": {"type": "object"}}, ("plan",)),
