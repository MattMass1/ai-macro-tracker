...
FOODS: dict[str, dict[str, Any]] = {
    ...
    "eggs": {"name":"chicken egg","basis":"raw","grams":52.7,
        "macros":(131,12.6,0,9,0),"source":f"{COFID}, food 12-937; Health Canada CNF food 125 serving weight"},
    "egg": {"alias_of":"eggs"},
    ...
    "banana": {"name":"banana","basis":"as-sold flesh","grams":100,
        "macros":(81,1.2,20.3,.1,1.4),"source":f"{COFID}, food 14-318"},
    "apple": {"name":"apple","basis":"as-sold raw, skin on","grams":182,
        "macros":(51,.6,11.6,.5,1.2),"source":f"{COFID}, food 14-319; Health Canada CNF food 1696 medium weight"},
